...
from object_detection import eval_util_custom as eval_util
...
def evaluate_weights(create_input_dict_fn, create_model_fn, eval_config, categories,
             all_weights, eval_dir, graph_hook_fn=None, evaluator_list=None):
  ...
  init_assign_op, init_feed_dict = slim.assign_from_values(all_weights)
  def _restore_weights(sess):
